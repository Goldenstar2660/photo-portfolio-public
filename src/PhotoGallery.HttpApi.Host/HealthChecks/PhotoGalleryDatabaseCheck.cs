...
public class PhotoGalleryDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PhotoGalleryDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
